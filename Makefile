...
SRC = UI/UI.c ValueGrabber/fetcher.c UI/graph/plot.c Algorithms/bot.c UI/graph/pbPlot.c UI/graph/supportLib.c                                                            
OBJ = ${SRC:.c=.o}                                                              
DEP = ${SRC:.c=.d}                                                              
                                                                                
all: main                                                                         
                                                                                
main: UI/UI.o ValueGrabber/fetcher.o UI/graph/plot.o Algorithms/bot.o UI/graph/pbPlots.o UI/graph/supportLib.o                                                                    
