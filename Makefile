...
CrypTrade: UI/UI.o ValueGrabber/fetcher.o Algorithms/bot.o #UI/graph/pbPlots.o UI/graph/supportLib.o #UI/graph/plot.o
	gcc -o CrypTrade main.c UI/UI.c ValueGrabber/fetcher.c Algorithms/bot.c `pkg-config --cflags --libs gtk+-3.0` -lcurl `pkg-config --libs sdl` -rdynamic -std=c99 -O3 -g
...
clean:
	...
	${RM} CrypTrade	 #remove main program
	${RM} -r cache
	${RM} *txt
	${RM} CrypTrade.d
	${RM} pl
